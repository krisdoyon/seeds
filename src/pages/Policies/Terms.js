    ...
    <section className={`container ${styles.wrapper}`}>
      ...
      <div className={styles.policy}>
        ...
        <p>
          ...
          use of our website. These Terms will be applied fully and affect to
          ...
          website if you disagree with any of these website Terms and
          Conditions.
        </p>
        ...
        <p>
          ...
          and we may further restrict access by you to any areas of this
        ...
        <p>
          ...
          display on this website. By displaying Your Content, you grant us a
          ...
          third-party's rights. We reserve the right to remove any of Your
        ...
        <p>
          ...
          the materials contained on this website. Also, nothing contained on
          this website shall be interpreted as advising you.
        </p>
        <h3>Limitation of liability</h3>
        <p>
          In no event shall we, nor any of its officers, directors and
          ...
          under contract. We, including our officers, directors and employees
        ...
        <h3>Entire Agreement These Terms</h3>
        <p>
          constitute the entire agreement between us and you in relation to your
